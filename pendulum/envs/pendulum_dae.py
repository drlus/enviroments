...
class model: 
    ...
    def __init__(self): 
        ...
        #self.sp_jac_ini = sspa.load_npz('./__pycache__/pendulum_dae_sp_jac_ini_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz('./__pycache__/pendulum_dae_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz('./__pycache__/pendulum_dae_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz('./__pycache__/pendulum_dae_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz('./__pycache__/pendulum_dae_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz('./__pycache__/pendulum_dae_Hu_run_num.npz')        
